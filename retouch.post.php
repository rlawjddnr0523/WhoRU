...
<div class="wrapper d-flex align-items-stretch">
    ...
    <div id="content" class="p-4 p-md-5">
        ...
        ?><h3 class="mb-4"><span class="fa fa-bars"></span> 게시물 수정하기</h3>
        <h6 class="mb-4"><span class="fa fa-address-card"></span> 사용자 이름 : <?php echo $_SESSION['userid']; ?></h6>
        <form method="post" action="retouch.post.post.php?id=<?php echo $_GET['id']; ?>">
            <table>
                <tr>
                    <td><label>제목 : </label></td><td><input type="text" placeholder="게시물 제목을 쓰세요" required size = 17px id="title" name="title" value="<?php echo $row['blog_title']; ?>"></td>
                </tr>
                <tr>
                    <td><label>내용 : </label></td><td><textarea placeholder="게시물 내용을 쓰세요" required style="resize: none; width: 200px; height: 100px" id="contents" name="contents" ><?php echo $row['blog_contents']; ?></textarea></td>
                </tr>
                <tr>
                    <td></td><td><input type="submit" value="게시물 수정하기"></td>
                </tr>
            </table>
        </form>
        <?php
